...
def render(user: Dict[str, Any], role: str, logger: Any) -> None:
    # Shortcut to the standalone HTML dashboard (opens in new tab)
    st.markdown(
        '<a href="http://127.0.0.1:8502" target="_blank" rel="noopener" '
        'style="display:inline-flex;align-items:center;gap:6px;padding:6px 14px;'
        'background:#0e1014;color:#fff;border-radius:8px;font-size:13px;'
        'font-weight:500;text-decoration:none;margin-bottom:12px;">'
